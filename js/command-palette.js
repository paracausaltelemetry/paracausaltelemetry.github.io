const commandItems = [
  ...
  { label: "Projects", detail: "RFIDemon, Pwn2Play, and the CTF archive", href: "/projects/" },
  ...
  { label: "Credentials", detail: "Credential details", href: "/credentials/" },
  { label: "Design", detail: "Typography, colour, spacing and structure of the site", href: "/design/" },
  { label: "RFIDemon", detail: "Raspberry Pi RFID analysis and cloning workstation", href: "/projects/#rfidemon" },
  { label: "Pwn2Play", detail: "Capture-the-flag platform and challenge archive", href: "/projects/pwn2play/" },
  { label: "Alchemist", detail: "OT network modelling sandbox", href: "/projects/#alchemist" },
  { label: "SC-200", detail: "Microsoft Security Operations Analyst, in progress", href: "/credentials/" },
